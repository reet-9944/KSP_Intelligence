      ...
      <div className="dashboard-grid" style={{ gridTemplateColumns: '1fr 2fr' }}>
        ...
        <div className="glass-panel" style={{ padding: '24px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '24px' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginBottom: '4px' }}>Raja "The Phantom"</h2>
            <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>Alias: K. Rajendra | ID: KSP-9023</p>
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          <div className="glass-panel" style={{ padding: '24px' }}>
            ...
            <div style={{ display: 'flex', gap: '8px', marginTop: '16px', flexWrap: 'wrap' }}>
              <span className="badge">Technical Sabotage</span>
              <span className="badge">Night Operations</span>
              <span className="badge">Organized Fencing</span>
            </div>
          </div>
          ...
          <div className="glass-panel" style={{ padding: '24px' }}>
            ...
            <ul style={{ listStyle: 'none', padding: 0 }}>
              <li style={{ padding: '12px 0', borderBottom: '1px solid var(--border-glass)', display: 'flex', justifyContent: 'space-between' }}>
                <div>
